...
function comprobar(){
    ...
    RequerimientosAdicionales, ClientesDelProducto, Elaboro, Aprobo, Valido
   ...
   document.getElementById("respuesta8").innerHTML="<h3> Arquitectura: "+Arquitectura+"</h3>" 
    ...
    document.getElementById("respuesta18").innerHTML="<h3> Elaboro: "+Elaboro+"</h3>" 
    console.log(Elaboro) 

    Aprobo = document.getElementById("Aprobo").value
    document.getElementById("respuesta19").innerHTML="<h3> Aprobo: "+Aprobo+"</h3>" 
    console.log(Aprobo)

    Valido = document.getElementById("Valido").value
    document.getElementById("respuesta20").innerHTML="<h3> Valido: "+Valido+"</h3>" 
    console.log(Valido)
